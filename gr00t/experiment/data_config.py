...
class BimanualARXGripperDataConfig(BaseDataConfig):
    video_keys = [
    ...
    state_keys = [
        "state.qpos_left_arm",
        "state.qpos_right_arm",
        "state.qvel_left_arm",
        "state.qvel_right_arm",
        "state.ee_left_arm",
        "state.ee_right_arm",
        "state.torque_left_arm",
        "state.torque_right_arm",
    ]
    action_keys = [
        "action.action_left_arm",
        "action.action_right_arm",
    ]
...
DATA_CONFIG_MAP = {
    ...
    "dual_arx":BimanualARXGripperDataConfig(),
}
